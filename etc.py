...
''' pre-plotting '''
plot_typ_keys = ['snr', 'obv_spec', 'sky_background', 'dichroic_throughput', 'grating_throughput', 'ccd_qe', 'atmospheric_extinction']
plot_y_blue, plot_y_red = [], []
if plot_typ in plot_typ_keys:
    if (plot_typ.lower() == plot_typ_keys[0]):
        ...
        if (channel == 'red') or (channel == 'both'):
            plot_y_red = snr_red
    elif (plot_typ.lower() == plot_typ_keys[1]):
    ...
    elif (plot_typ.lower() == plot_typ_keys[2]):
    ...
    elif (plot_typ.lower() == plot_typ_keys[3]):
    ...
    elif (plot_typ.lower() == plot_typ_keys[4]):
    ...
    elif (plot_typ.lower() == plot_typ_keys[5]):
        ...
        if (channel == 'red') or (channel == 'both'):
            plot_y_red = red_ccd
    elif (plot_typ.lower() == plot_typ_keys[6]):
