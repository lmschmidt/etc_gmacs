...
'''
    GMACS ETC : Configuration file

'''


''' paths '''
# explicit to ensure indices are consistent
...
star_types_files = ['o5v.dat', 'b0v.dat', 'b57v.dat', 'a0v.dat', 'a5v.dat',
                    'f0v.dat', 'g0v.dat', 'g5v.dat', 'k0v.dat', 'k5v.dat', 'm0v.dat', 'm5v.dat']

filter_path = 'core/filters/'
filter_files = ['photonUX.dat', 'photonB.dat', 'photonV.dat', 'photonR.dat',
                'photonI.dat', 'u.dat', 'g.dat', 'r.dat', 'i.dat', 'z.dat']
