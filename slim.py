...
class session:
    ...
    def snr(self, caller):
        ...
        total_eff_noise_blue, total_eff_noise_red = self.recalculate_efficiency_noise(dichro_blue=dichro_blue, dichro_red=dichro_red, grating_blue=grating_blue,
                                                                                      grating_red=grating_red, ccd_blue=ccd_blue, ccd_red=ccd_red, mirror_loss=mirror_loss)
        ...
        flux, flux_y = self.recalculate_flux(grating_blue=grating_blue, grating_red=grating_red, moon_days=moon_days, selected_filter_x=selected_filter_x,
                                             selected_filter_y=selected_filter_y, lambda_A=lambda_A, object_x=object_x, object_y=object_y, flux_A=flux_A)
        counts = self.recalculate_counts(flux_y=flux_y, area=area)
        total_eff_blue, total_eff_red = self.recalculate_efficiency(grating_blue=grating_blue, grating_red=grating_red, dichro_blue=dichro_blue, dichro_red=dichro_red,
    ...
    def os(self):
        ...
        noise_blue, noise_red = self.recalculate_noise(counts_noise=counts_noise, total_eff_noise_blue=total_eff_noise_blue, total_eff_noise_red=total_eff_noise_red)
        object_x, object_y, flux_A = self.change_object_type(selected_filter_x=selected_filter_x, selected_filter_y=selected_filter_y, lambda_A=lambda_A)
        flux, flux_y = self.recalculate_flux(grating_blue=grating_blue, grating_red=grating_red, moon_days=sky_y, selected_filter_x=selected_filter_x,
                                             selected_filter_y=selected_filter_y, lambda_A=lambda_A, object_x=object_x, object_y=object_y, flux_A=flux_A)
        counts = self.recalculate_counts(flux_y=flux_y, area=area)
        total_eff_blue, total_eff_red = self.recalculate_efficiency(grating_blue=grating_blue, grating_red=grating_red, dichro_blue=dichro_blue, dichro_red=dichro_red,
                                                                    ccd_blue=ccd_blue, ccd_red=ccd_red, extinction=extinction, mirror_loss=mirror_loss)
