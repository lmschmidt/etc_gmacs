...
f5v_x, f5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[12], usecols=(0, 1), unpack=True)
g0v_x, g0v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[6], usecols=(0, 1), unpack=True)
g5v_x, g5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[7], usecols=(0, 1), unpack=True)
k0v_x, k0v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[8], usecols=(0, 1), unpack=True)
k5v_x, k5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[9], usecols=(0, 1), unpack=True)
