...
sb1_x, sb1_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[0], usecols=(0, 1), unpack=True)
sb2_x, sb2_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[1], usecols=(0, 1), unpack=True)
sb3_x, sb3_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[2], usecols=(0, 1), unpack=True)
sb4_x, sb4_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[3], usecols=(0, 1), unpack=True)
sb5_x, sb5_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[4], usecols=(0, 1), unpack=True)
sb6_x, sb6_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[5], usecols=(0, 1), unpack=True)
s0_x, s0_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[6], usecols=(0, 1), unpack=True)
sa_x, sa_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[7], usecols=(0, 1), unpack=True)
sb_x, sb_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[8], usecols=(0, 1), unpack=True)
sc_x, sc_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[9], usecols=(0, 1), unpack=True)
bulge_x, bulge_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[10], usecols=(0, 1), unpack=True)
ellipticals_x, ellipticals_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[11], usecols=(0, 1), unpack=True)
lbg_all_flam_x, lbg_all_flam_y = np.loadtxt(etpaths.galaxy_path / etpaths.galaxy_files[12], usecols=(0, 1), unpack=True)

o5v_x, o5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[0], usecols=(0, 1), unpack=True)
b0v_x, b0v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[1], usecols=(0, 1), unpack=True)
b57v_x, b57v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[2], usecols=(0, 1), unpack=True)
a0v_x, a0v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[3], usecols=(0, 1), unpack=True)
a5v_x, a5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[4], usecols=(0, 1), unpack=True)
f0v_x, f0v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[5], usecols=(0, 1), unpack=True)
f5v_x, f5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[6], usecols=(0, 1), unpack=True)
g0v_x, g0v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[7], usecols=(0, 1), unpack=True)
g5v_x, g5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[8], usecols=(0, 1), unpack=True)
k0v_x, k0v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[9], usecols=(0, 1), unpack=True)
k5v_x, k5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[10], usecols=(0, 1), unpack=True)
m0v_x, m0v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[11], usecols=(0, 1), unpack=True)
m5v_x, m5v_y = np.loadtxt(etpaths.stellar_path / etpaths.stellar_files[12], usecols=(0, 1), unpack=True)
...
skyfile_07d_x, skyfile_07d_y = np.loadtxt(etpaths.skyfiles_path / etpaths.skyfiles[2], usecols=(0, 1), unpack=True)
skyfile_10d_x, skyfile_10d_y = np.loadtxt(etpaths.skyfiles_path / etpaths.skyfiles[3], usecols=(0, 1), unpack=True)
skyfile_14d_x, skyfile_14d_y = np.loadtxt(etpaths.skyfiles_path / etpaths.skyfiles[4], usecols=(0, 1), unpack=True)
